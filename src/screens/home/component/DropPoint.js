...
const DropPoint = ({
  ...
  const getAddress = (data, details) => {
    ...
    //     setDropCountry(addressDetails?.[i]?.long_name);
    //   }

    //   if (addressDetails[i].types[0] == 'postal_code') {
    //     setDropZipCode(addressDetails?.[i]?.long_name);
    //   }

    //   if (addressDetails[i].types[0] == 'administrative_area_level_1') {
    //     setDropState(addressDetails?.[i]?.long_name);
    //   }
    ...
    //   ) {
    //     setDropCity(addressDetails?.[i]?.long_name);
    //   }
    // }
  };
  return (
      ...
      <View
        ...
        <GooglePlacesAutocomplete
          ...
          onPress={(data, details) => {
            setDropStreetAddress(data.description);
